...
def crear_generadores(train_dir, test_dir, target_size=(128, 128), batch_size=batch_size, augmentation=True):
    if augmentation:
...
def resnet_layer(inputs, num_filters=16, kernel_size=3, strides=1,
                 activation='relu', batch_normalization=True, conv_first=True, dropout_rate=0.5):
...
history_df.to_csv(os.path.join(result_dir, 'history.csv'))
